...
local user_opts = {
    ...
    icon_style = "outline",                  -- "mixed", "filled", "outline"
    font = "mpv-osd-symbols",              -- font for the OSC (default: mpv-osd-symbols or the one set in mpv.conf)

    idlescreen = false,                     -- show mpv logo when idle
    ...
    keeponpause = "bottombar",             -- keep OSC visible while paused: "no", "bottombar", "both"
    ...
    windowcontrols_independent = false,     -- show window controls (top bar) and bottom bar independently on hover
    ...
    download_path = "~/Videos/MPV",       -- default download directory for videos (https://mpv.io/manual/master/#paths)
