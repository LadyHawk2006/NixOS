...
hl.bind("ALT + C", hl.dsp.exec_cmd("sh -c 'GSETTINGS_SCHEMA_DIR=/home/shadrack/.local/bin/data /home/shadrack/.local/bin/chorus'"))
...
hl.bind("XF86AudioMute", hl.dsp.exec_cmd("dms ipc call mpris playPause"), { repeating = true })
